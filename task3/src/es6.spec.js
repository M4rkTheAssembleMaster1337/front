...
describe('es6', () => {
    ...
    describe('#Dictionary', () => {
        it('экземпляр класса создается', () => {
            ...
            // Проверка аргументов
            assert.strictEqual(dic.set(1, "abacaba"), null);
            assert.strictEqual(dic.set("abacaba", "abababa"), undefined);

            //Геттер по ключу
            assert.strictEqual(dic.get("abacaba"), "abababa");
            assert.strictEqual(dic.get("a"), undefined);
        });
    });
});